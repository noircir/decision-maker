...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.optionPickHandler = _this.optionPickHandler.bind(_this);
        _this.addOptionHandler = _this.addOptionHandler.bind(_this);
        _this.deleteSingleOptionHandler = _this.deleteSingleOptionHandler.bind(_this);
        _this.state = {
    ...
    _createClass(App, [{
        ...
        key: 'optionPickHandler',
        value: function optionPickHandler() {
            var choice = Math.floor(Math.random() * Math.floor(this.state.options.length));
        ...
        value: function addOptionHandler(option) {
            ...
            this.setState(function () {
                return {
                    options: [].concat(_toConsumableArray(_this2.state.options), [option])
                };
            });
        }
    }, {
        key: 'deleteSingleOptionHandler',
        value: function deleteSingleOptionHandler(option) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(AddOption, { addOptionHandler: this.addOptionHandler })
            );
        }
    }]);
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            { onClick: function onClick() {
                    return props.deleteSingleOptionHandler(props.optionText);
                }
            },
            'Remove'
        )
...
var AddOption = function (_React$Component2) {
    ...
    function AddOption(props) {
        ...
        _this3.addOptionHandler = _this3.addOptionHandler.bind(_this3);
        _this3.state = {
            error: null
        };
        return _this3;
    ...
    _createClass(AddOption, [{
        ...
        value: function addOptionHandler(e) {
            e.preventDefault();
            var chosenOption = e.target.elements.chosenOption.value.trim();
            ...
            var error = this.props.addOptionHandler(chosenOption);
            this.setState(function () {
                return { error: error };
            });
            if (!error) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', name: 'chosenOption' }),
                    _react2.default.createElement(
                        'button',
                        null,
                        'Add Choice'
